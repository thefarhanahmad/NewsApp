...
const AllSectionArticle = ({data}) => {
  ...
  return (<>
    {data ?data.map((element)=>{
      return <SingleArticle key={element.category} category={element.category} imgData={element.imgData} vidData={element.vidData}/>
            ...
            {(imgData && imgData.length>0) &&(
              ...
              <div className="main-page-technology-third-column">
                ...
                {(vidData.map((element,index)=>{
                  ...
                  return (
                    <VideoCard fromVideoGallery={false} key={element._id} data={element} color="black" width="100%" />
                  )
