...
import JoditEditor from "jodit-react";
  ...
  const [filterItemResponse, setfilterItemResponse] = useState("");
    ...
    const onFilter = () =>{
      ...
      axios.get(
          `${API_URL}/live?${filterItem}=${filterItemResponse}`
        )
        .then((poll) => {
    ...
    return (
      <>
        ...
        <Row gutter={20}>
            ...
            <Col span={6}>
              <Input value={filterItemResponse } onChange={e=>setfilterItemResponse(e.target.value)} placeholder={filterItem == "id"?"Id":"Title"} style={{ width: "100%" }} />
