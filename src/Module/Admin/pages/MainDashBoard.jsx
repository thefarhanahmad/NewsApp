...
import { FileImageOutlined, FilePdfOutlined, FileTextOutlined, HistoryOutlined, MessageOutlined, PlayCircleOutlined, UserOutlined, VideoCameraOutlined } from '@ant-design/icons';
...
async function fetchFilterUserData(filter) {
  const response = await axios.get(`${API_URL}/dashboard/users${filter}`);
    ...
    setUserChartData((prevState)=>({...prevState,chartData,TotalCount:data.activeCount+data.inactiveCount}));
}
async function fetchFilterBreakingNewsData(filter) {
  const response = await axios.get(`${API_URL}/dashboard/breakingNews${filter}`);
    const data = response.data;
    const chartData = {
    ...
    setBreakingNewsChartData((prevState)=>({...prevState,chartData:chartData,TotalCount:data.activeCount+data.inactiveCount}))
}
async function fetchFilterTopStoriesData(filter){
  try {
    const response = await axios.get(`${API_URL}/dashboard/topStories${filter}`);
    const data = response.data;
    ...
    setTopStoriesChartData((prevState)=>({...prevState,chartData,TotalCount:data.activeCount+data.inactiveCount}));
  } catch (error) {
...
async function fetchFilterUploadsData(filter){
  try {
    ...
    setUploadChartData((prevState)=>({...prevState,chartData,TotalCount:data.activeCount+data.inactiveCount}));
  } catch (error) {
...
async function fetchFilterADSData(filter){
  try {
    ...
    setADSChartData((prevState)=>({...prevState,chartData,TotalCount:data.activeCount+data.inactiveCount}));
  } catch (error) {
    console.error('Error fetching user data:', error);
  }
};
...
async function fetchFilterFlashNewsData(filter){
  try {
    const response = await axios.get(`${API_URL}/dashboard/flashNews${filter}`);
    const data = response.data;
    ...
    setFlashNewsChartData((prevState)=>({...prevState,chartData,TotalCount:data.activeCount+data.inactiveCount}));
  } catch (error) {
    console.error('Error fetching user data:', error);
  }
};
async function fetchFilterStoriesData(filter){
  try {
    ...
    setStoriesChartData((prevState)=>({...prevState,chartData,TotalCount:data.activeCount+data.inactiveCount}));
  } catch (error) {
    console.error('Error fetching user data:', error);
  }
};
async function fetchFilterVideosData(filter){
  try {
    ...
    setVideosChartData((prevState)=>({...prevState,chartData,TotalCount:data.activeCount+data.inactiveCount}));
  } catch (error) {
    console.error('Error fetching user data:', error);
  }
};
...
async function fetchFilterPhotosData(filter){
  try {
    ...
    setPhotosChartData((prevState)=>({...prevState,chartData,TotalCount:data.activeCount+data.inactiveCount}));
  } catch (error) {
    console.error('Error fetching user data:', error);
  }
};
async function fetchFilterCommentData(filter){
  try {
    const response = await axios.get(`${API_URL}/dashboard/comments${filter}`);
    const data = response.data;
    ...
    setCommentChartData((prevState)=>({...prevState,chartData,TotalCount:data.activeCount+data.inactiveCount}));
  } catch (error) {
...
async function fetchFilterLiveData(filter){
  try {
    ...
    setLiveChartData((prevState)=>({...prevState,chartData,TotalCount:data.activeCount+data.inactiveCount}));
  } catch (error) {
...
async function fetchFilterPollData(filter){
  try {
    ...
    setPollChartData((prevState)=>({...prevState,chartData,TotalCount:data.activeCount+data.inactiveCount}));
  } catch (error) {
...
async function fetchFilterReportData(filter){
  try {
    ...
    setReportChartData((prevState)=>({...prevState,chartData,TotalCount:data.activeCount+data.inactiveCount}));
  } catch (error) {
    console.error('Error fetching poll data:', error);
  }
};
async function fetchFilterCategoryData(filter){
  try {
    ...
    setCategoryChartData((prevState)=>({...prevState,chartData,TotalCount:data.activeCount+data.inactiveCount}));
  } catch (error) {
...
async function fetchFilterSubCatData(filter){
  try {
    const response = await axios.get(`${API_URL}/dashboard/subCategory${filter}`);
    const data = response.data;
    ...
    setSubCatChartData((prevState)=>({...prevState,chartData,TotalCount:data.activeCount+data.inactiveCount}));
  } catch (error) {
...
async function fetchFilterCatArticlesData(filter){
  try {
    const response = await axios.get(`${API_URL}/dashboard/categroyAritcles${filter}`);
    const data = response.data;
      const mainArr = []
  ...
  async function fetchUsersData(){
    try {
      ...
      setUserChartData((prevState)=>({...prevState,todayData:data.todayData,chartData,TotalCount:data.activeCount+data.inactiveCount}));
    } catch (error) {
      console.error('Error fetching user data:', error);
    }
  };
  async function fetchBreakingNewsData(){
    try {
      ...
      setBreakingNewsChartData((prevState)=>({...prevState,chartData,todayData:data.todayData,TotalCount:data.activeCount+data.inactiveCount}));
    } catch (error) {
      console.error('Error fetching user data:', error);
    }
  };
  async function fetchTopStoriesData(){
    try {
      ...
      setTopStoriesChartData((prevState)=>({...prevState,chartData,todayData:data.todayData,TotalCount:data.activeCount+data.inactiveCount}));
    } catch (error) {
      console.error('Error fetching user data:', error);
    }
  };
  async function fetchUploadsData(){
    try {
      ...
      setUploadChartData((prevState)=>({...prevState,chartData,todayData:data.todayData,TotalCount:data.activeCount+data.inactiveCount}));
    } catch (error) {
      console.error('Error fetching upload data:', error);
    }
  };
  async function fetchADSData(){
    try {
      ...
      setADSChartData((prevState)=>({...prevState,chartData,todayData:data.todayData,TotalCount:data.activeCount+data.inactiveCount}));
    } catch (error) {
      console.error('Error fetching user data:', error);
    }
  };
  async function fetchFlashNewsData(){
    try {
      ...
      setFlashNewsChartData((prevState)=>({...prevState,chartData,todayData:data.todayData,TotalCount:data.activeCount+data.inactiveCount}));
    } catch (error) {
      console.error('Error fetching user data:', error);
    }
  };
  async function fetchStoriesData(){
    try {
      ...
      setStoriesChartData((prevState)=>({...prevState,chartData,todayData:data.todayData,TotalCount:data.activeCount+data.inactiveCount}));
    } catch (error) {
      console.error('Error fetching user data:', error);
    }
  };
  async function fetchVideosData(){
    try {
      ...
      setVideosChartData((prevState)=>({...prevState,chartData,todayData:data.todayData,TotalCount:data.activeCount+data.inactiveCount}));
    } catch (error) {
      console.error('Error fetching user data:', error);
    }
  };
  async function fetchPhotosData(){
    try {
      ...
      setPhotosChartData((prevState)=>({...prevState,chartData,todayData:data.todayData,TotalCount:data.activeCount+data.inactiveCount}));
    } catch (error) {
      console.error('Error fetching user data:', error);
    }
  };
  async function fetchCommentData(){
    try {
      ...
      setCommentChartData((prevState)=>({...prevState,chartData,todayData:data.todayData,TotalCount:data.activeCount+data.inactiveCount}));
    } catch (error) {
      console.error('Error fetching comment data:', error);
    }
  };
  async function fetchLiveData(){
    try {
      ...
      setLiveChartData((prevState)=>({...prevState,chartData,todayData:data.todayData,TotalCount:data.activeCount+data.inactiveCount}));
    } catch (error) {
      console.error('Error fetching comment data:', error);
    }
  };
  async function fetchPollData(){
    try {
      ...
      setPollChartData((prevState)=>({...prevState,chartData,todayData:data.todayData,TotalCount:data.activeCount+data.inactiveCount}));
    } catch (error) {
      console.error('Error fetching poll data:', error);
    }
  };
  ...
  async function fetchReportData(){
    try {
      ...
      setReportChartData((prevState)=>({...prevState,chartData,todayData:data.todayData,TotalCount:data.activeCount+data.inactiveCount}));
    } catch (error) {
  ...
  async function fetchCatergoryData(){
    try {
      ...
      setCategoryChartData((prevState)=>({...prevState,chartData,todayData:data.todayData,TotalCount:data.activeCount+data.inactiveCount}));
    } catch (error) {
      console.error('Error fetching Category data:', error);
    }
  };
  async function fetchSubCatData(){
    try {
      ...
      setSubCatChartData((prevState)=>({...prevState,chartData,todayData:data.todayData,TotalCount:data.activeCount+data.inactiveCount}));
    } catch (error) {
      console.error('Error fetching subCategory data:', error);
    }
  };
...
const { RangePicker } = DatePicker;
  ...
  return (
    <>
    {Loading?<p style={{color:"white",backgroundColor:"red"}}>Loading ...</p>:null}
    <h1 className='dashMainHeading'>Dashboard</h1>
    <div className='dashToplineElements'>
    <RangePicker
              style={{ width: "70%" }}
              // placeholder="By Date"
              value={filterItemDate?[moment(filterItemDate[0]), moment(filterItemDate[1])]:""}
              onChange={(_, dateString) => {
                console.log(dateString);
                setfilterItemDate(dateString)
              }}
            />
            <Button style={{backgroundColor:"blue",color:"white"}} onClick={onFilter}>Filter</Button>
            <Button style={{backgroundColor:"red",color:"white"}} onClick={()=>{
              setfilterItemDate()
              onDefaultFetcher()}}>Reset</Button>
    </div>
    <div className='mainDashBoardContainer'>
        
        <div className='mainDashBoardContainerChild mainDashBoardContainerChild1'
        ...
        <div className='mainDashBoardContainerChild mainDashBoardContainerChild2'
        ...
        >
            ...
            <div className='dashsmallContainer'>
              <div className='dashsmallContaineritem dashsmallContaineritem1'>
                ...
                <p className='dashCardNumber'>{BreakingNewsChartData?.TotalCount}</p>
              </div>
              <div className='dashsmallContaineritem dashsmallContaineritem2'>
              <p className='dashCardTitle'>Today</p>
                <p className='dashCardNumber'>{BreakingNewsChartData?.todayData}</p>
        ...
        <div className='mainDashBoardContainerChild mainDashBoardContainerChild3'
        ...
        >
            ...
            <div className='dashsmallContainer'>
              <div className='dashsmallContaineritem dashsmallContaineritem1'>
                ...
                <p className='dashCardNumber'>{TopStoriesChartData?.TotalCount}</p>
              </div>
              <div className='dashsmallContaineritem dashsmallContaineritem2'>
              <p className='dashCardTitle'>Today</p>
        ...
        <div className='mainDashBoardContainerChild mainDashBoardContainerChild7'
        ...
        <div className='mainDashBoardContainerChild mainDashBoardContainerChild4'
        ...
        <div className='mainDashBoardContainerChild mainDashBoardContainerChild5'
        ...
        <div className='mainDashBoardContainerChild mainDashBoardContainerChild6'
        ...
        {CatArticlesChartData?.map((categroy,index)=>(
           ...
           <div className={`mainDashBoardContainerChild mainDashBoardContainerChild${index?index % 7:1}`}
      ...
      <Modal
        ...
        footer={null}
      >
        {selectedChart === 'user' && <BarChart TotalCount={userChartData.TotalCount} data={userChartData.chartData}/>}
        {selectedChart === 'breakingNews' && <BarChart TotalCount={BreakingNewsChartData.TotalCount} data={BreakingNewsChartData.chartData}/>}
        {selectedChart === 'topStories' && <BarChart TotalCount={TopStoriesChartData.TotalCount} data={TopStoriesChartData.chartData}/>}
        {selectedChart === 'uploads' && <BarChart TotalCount={UploadChartData.TotalCount} data={UploadChartData.chartData}/>}
        {selectedChart === 'ads' && <BarChart TotalCount={ADSChartData.TotalCount} data={ADSChartData.chartData}/>}
        {selectedChart === 'flashNews' && <BarChart TotalCount={FlashNewsChartData.TotalCount} data={FlashNewsChartData.chartData}/>}
        {selectedChart === 'stories' && <BarChart TotalCount={StoriesChartData.TotalCount} data={StoriesChartData.chartData}/>}
        {selectedChart === 'videos' && <BarChart TotalCount={VideosChartData.TotalCount} data={VideosChartData.chartData}/>}
        {selectedChart === 'photos' && <BarChart TotalCount={PhotosChartData.TotalCount} data={PhotosChartData.chartData}/>}
        {selectedChart === 'comment' && <BarChart TotalCount={CommentChartData.TotalCount} data={CommentChartData.chartData}/>}
        {selectedChart === 'live' && <BarChart TotalCount={LiveChartData.TotalCount} data={LiveChartData.chartData}/>}
        {selectedChart === 'poll' && <BarChart TotalCount={PollChartData.TotalCount} data={PollChartData.chartData}/>}
        {selectedChart === 'report' && <BarChart TotalCount={ReportChartData.TotalCount} data={ReportChartData.chartData}/>}
        {selectedChart === 'content' && <BarChart TotalCount={CategoryChartData.TotalCount} data={CategoryChartData.chartData}/>}
        {selectedChart === 'subCat' && <BarChart TotalCount={SubCatChartData.TotalCount} data={SubCatChartData.chartData}/>}
        {CatArticlesChartData?.map((category)=>(
          <>
          {selectedChart === category.category && 
          <BarChart TotalCount={category.TotalCount} data={category.chartData}/>
        }
        </>
