...
const OtpVerify = () => {
  ...
  async function reSendOTP(){
      ...
      const _id =  localStorage.getItem("id")
      const forgot =  localStorage.getItem("forgot")
      axios.post(`${API_URL}/resendOTP`,{_id}).then((data)=>{
        console.log(data)
  ...
  return (
    <div className="user-registration-form">
      ...
      <div onClick={!click?reSendOTP:()=>{}} style={{marginTop:10,fontSize:"16px",fontFamily:"Poppins",fontWeight:600,color:click?"rgba(0,0,0,0.3)":"red",cursor:"pointer"}}>
